...
//        )
//    totalOffset =
//        recyclerView.computeVerticalScrollRange() - recyclerViewHeight
//    velocity = (abs(flingY) / recyclerViewHeight).toFloat()
//    property = DynamicAnimation.SCALE_Y
//    if (flingY > 0) {
//        recyclerView.pivotY = recyclerViewHeight.toFloat()
//    } else {
//        recyclerView.pivotY = 0f
//    }
//} else if (flingX != 0) {
...
//        )
//    totalOffset =
//        recyclerView.computeHorizontalScrollRange() - recyclerViewWidth
//    velocity = (abs(flingX) / recyclerViewWidth).toFloat()
//    property = DynamicAnimation.SCALE_X
//    if (flingX > 0) {
//        recyclerView.pivotX = recyclerViewWidth.toFloat()
//    } else {
//        recyclerView.pivotX = 0f
//    }
//}