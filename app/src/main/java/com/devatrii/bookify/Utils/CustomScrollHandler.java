...
public class CustomScrollHandler extends RelativeLayout implements ScrollHandle {
    ...
    public CustomScrollHandler(Context context) {
        this(context, false);
    }

    public CustomScrollHandler(Context context, boolean inverted) {
        super(context);
        ...
        Typeface customFont = ResourcesCompat.getFont(context, com.devatrii.bookify.R.font.roboto);
    ...
    public void setupLayout(PDFView pdfView) {
        ...
        if (pdfView.isSwipeVertical()) {
            ...
            if (inverted) { // left
                ...
                background = ContextCompat.getDrawable(context, com.devatrii.bookify.R.drawable.handle_right);
            } else { // right
    ...
    @Override
    public void show() {
        FrontendUtilsKt.hideHandle(this);
    }

    @Override
    public void hide() {
        FrontendUtilsKt.showHandle(this,0f);
    }
